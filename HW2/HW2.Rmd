...
```
  ...
  + $\hat{\beta_{2}}=2.51$
    $\hat{\beta_{1}}$ is not a good estimator of $\beta_{1}$. t-statistic is low and p value is just above the threshold of 
    5%
...
+ 7. Q7
  ...
  + 7a. 
  + Plots show the predictor-response with highest t-values
